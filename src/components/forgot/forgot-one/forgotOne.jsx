    ...
    <div className="forgotone-container">
      ...
      <div className="forgotone-wrapper">
        <div className="forgotone-cont">
          <OnboardingHeader title="Reset Password" text="We’ll send a code to your email address to reset your password." />
      ...
      <p>
        Still having trouble logging in? <span onClick={action}>contact support</span>
      </p>
    </div>
  );
};
